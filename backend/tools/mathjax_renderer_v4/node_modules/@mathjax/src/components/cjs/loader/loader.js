...
loader_js_1.Loader.load.apply(loader_js_1.Loader, __spreadArray([], __read(loader_js_1.CONFIG.load), false)).then(function () { return loader_js_1.CONFIG.ready(); })
    .catch(function (message, name) { return loader_js_1.CONFIG.failed(message, name); });
