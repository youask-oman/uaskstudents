...
var ComplexityVisitor = (function (_super) {
    ...
    ComplexityVisitor.prototype.visitTree = function (node, id) {
    ...
    ComplexityVisitor.prototype.visitMfracNode = function (node, save) {
        var complexity = this.childrenComplexity(node) * this.complexity.script +
    ...
    ComplexityVisitor.prototype.visitMrootNode = function (node, save) {
        var complexity = this.childrenComplexity(node) +
