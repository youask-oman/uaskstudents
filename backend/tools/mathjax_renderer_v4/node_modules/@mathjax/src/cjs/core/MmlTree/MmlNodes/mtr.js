...
var MmlMtr = (function (_super) {
    ...
    MmlMtr.prototype.setChildInheritedAttributes = function (attributes, display, level, prime) {
        ...
        var balign = (0, string_js_1.split)(this.attributes.get('data-break-align'));
        if (this.arity === 1) {
    ...
    MmlMtr.defaults = __assign(__assign({}, MmlNode_js_1.AbstractMmlNode.defaults), { rowalign: Attributes_js_1.INHERIT, columnalign: Attributes_js_1.INHERIT, groupalign: Attributes_js_1.INHERIT, 'data-break-align': 'top' });
    return MmlMtr;
