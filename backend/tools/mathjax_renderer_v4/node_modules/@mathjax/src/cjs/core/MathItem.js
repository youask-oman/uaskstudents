...
exports.STATE = exports.AbstractMathItem = void 0;
...
var AbstractMathItem = (function () {
    ...
    AbstractMathItem.prototype.setMetrics = function (em, ex, cwidth, scale) {
        this.metrics = {
            em: em,
            ex: ex,
    ...
    AbstractMathItem.prototype.clear = function () { };
