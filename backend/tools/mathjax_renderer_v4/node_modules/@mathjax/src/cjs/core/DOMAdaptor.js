...
var AbstractDOMAdaptor = (function () {
    ...
    AbstractDOMAdaptor.prototype.setProperty = function (node, name, value) {
        node[name] = value;
    };
    AbstractDOMAdaptor.prototype.getProperty = function (node, name) {
        return node[name];
    };
    ...
    AbstractDOMAdaptor.prototype.cssText = function (node) {
