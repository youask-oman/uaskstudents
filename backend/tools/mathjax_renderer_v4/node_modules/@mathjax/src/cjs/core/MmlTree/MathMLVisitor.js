...
var MathMLVisitor = (function (_super) {
    ...
    MathMLVisitor.prototype.visitHtmlNode = function (node, parent) {
    ...
    MathMLVisitor.prototype.visitDefault = function (node, parent) {
        var e_2, _a;
        var mml = this.document.createElement(this.getKind(node));
    ...
    MathMLVisitor.prototype.addAttributes = function (node, mml) {
        ...
        try {
            for (var _b = __values(Object.keys(attributes)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var name_1 = _c.value;
                mml.setAttribute(name_1, attributes[name_1].toString());
            }
        }
