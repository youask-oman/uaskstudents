...
var MmlMaction = (function (_super) {
    ...
    MmlMaction.prototype.nextToggleSelection = function () {
        var selection = Math.max(1, parseInt(this.attributes.get('selection')) + 1);
        if (selection > this.childNodes.length) {
            selection = 1;
        }
        this.attributes.set('selection', selection);
    };
    MmlMaction.prototype.setChildInheritedAttributes = function (attributes, display, level, prime) {
        var _a, _b;
