...
var RenderList = (function (_super) {
    ...
    RenderList.action = function (id, action) {
        ...
        return [
            { id: id, renderDoc: renderDoc, renderMath: renderMath, convert: convert },
            priority,
        ];
    };
...
var AbstractMathDocument = (function () {
    ...
    AbstractMathDocument.prototype.renderPromise = function () {
        var _this = this;
        return this.whenReady(function () {
            return (0, Retries_js_1.handleRetriesFor)(function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.render();
                            return [4, this.actionPromises()];
                        case 1:
                            _a.sent();
                            this.clearPromises();
                            return [2, this];
    ...
    AbstractMathDocument.prototype.rerenderPromise = function (start) {
        var _this = this;
        if (start === void 0) { start = MathItem_js_1.STATE.RERENDER; }
        return this.whenReady(function () {
            return (0, Retries_js_1.handleRetriesFor)(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    AbstractMathDocument.prototype.convert = function (math, options) {
        ...
        var _a = (0, Options_js_1.userOptions)({
            ...
            scale: 1,
            family: '',
        }, options), format = _a.format, display = _a.display, end = _a.end, ex = _a.ex, em = _a.em, containerWidth = _a.containerWidth, scale = _a.scale, family = _a.family;
    ...
    AbstractMathDocument.prototype.convertPromise = function (math, options) {
        var _this = this;
        if (options === void 0) { options = {}; }
        return this.whenReady(function () {
            return (0, Retries_js_1.handleRetriesFor)(function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            node = this.convert(math, options);
                            return [4, this.actionPromises()];
                        case 1:
                            _a.sent();
                            this.clearPromises();
    ...
    AbstractMathDocument.prototype.whenReady = function (action) {
        var _this = this;
        return (this._readyPromise = this._readyPromise
            .catch(function (_) { })
            .then(function () {
            var ready = _this._readyPromise;
            _this._readyPromise = Promise.resolve();
            var result = action();
            var promise = _this._readyPromise.then(function () { return result; });
            _this._readyPromise = ready;
            return promise;
        }));
    };
    AbstractMathDocument.prototype.actionPromises = function () {
        return Promise.all(this._actionPromises);
    };
    AbstractMathDocument.prototype.clearPromises = function () {
        this._actionPromises = [];
    };
    AbstractMathDocument.prototype.savePromise = function (promise) {
    ...
    AbstractMathDocument.prototype.state = function (state, restore) {
        ...
        if (state < MathItem_js_1.STATE.FINDMATH) {
    ...
    AbstractMathDocument.prototype.reset = function (options) {
        ...
        if (options.all) {
            Object.assign(options, exports.resetAllOptions);
        }
        if (options.processed) {
            this.processed.reset();
        }
        if (options.inputJax) {
            this.inputJax.forEach(function (jax) { return jax.reset.apply(jax, __spreadArray([], __read(options.inputJax), false)); });
        }
        if (options.outputJax) {
            (_a = this.outputJax).reset.apply(_a, __spreadArray([], __read(options.outputJax), false));
        }
        return this;
    };
    ...
    AbstractMathDocument.prototype.done = function () {
    ...
    AbstractMathDocument.prototype.clearMathItemsWithin = function (containers) {
        ...
        try {
            for (var _c = __values(items.slice(0).reverse()), _d = _c.next(); !_d.done; _d = _c.next()) {
                var item = _d.value;
                item.clear();
            }
        }
        ...
        (_b = this.math).remove.apply(_b, __spreadArray([], __read(items), false));
        return items;
    };
    AbstractMathDocument.prototype.getMathItemsWithin = function (elements) {
        ...
        try {
            ITEMS: for (var _c = __values(this.math), _d = _c.next(); !_d.done; _d = _c.next()) {
                var item = _d.value;
                try {
                    for (var containers_1 = (e_13 = void 0, __values(containers)), containers_1_1 = containers_1.next(); !containers_1_1.done; containers_1_1 = containers_1.next()) {
