...
var AbstractInputJax = (function () {
    function AbstractInputJax(options) {
        ...
        this.preFilters = new FunctionList_js_1.FunctionList(this.options.preFilters);
        this.postFilters = new FunctionList_js_1.FunctionList(this.options.postFilters);
    }
