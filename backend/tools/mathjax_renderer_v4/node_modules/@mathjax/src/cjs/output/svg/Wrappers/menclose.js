...
exports.SvgMenclose = (function () {
    ...
    return _a = (function (_super) {
            ...
            SvgMenclose.prototype.line = function (pq) {
                var _b = __read(pq, 4), x1 = _b[0], y1 = _b[1], x2 = _b[2], y2 = _b[3];
            ...
            SvgMenclose.prototype.arrow = function (W, a, double, offset, dist) {
                ...
                var t = this.thickness;
                var t2 = t / 2;
                var _c = __read([t * this.arrowhead.x, t * this.arrowhead.y, t * this.arrowhead.dx], 3), x = _c[0], y = _c[1], dx = _c[2];
                var arrow = (double ?
            ...
            [
                'box',
                {
                    renderer: function (node, _child) {
                        var _b = node.getBBox(), w = _b.w, h = _b.h, d = _b.d;
