...
var StyleJsonSheet = (function () {
    ...
    StyleJsonSheet.prototype.getStyleRules = function (styles, spaces) {
        var e_3, _a;
        if (styles === void 0) { styles = this.styles; }
        ...
        try {
            for (var selectors_2 = __values(selectors), selectors_2_1 = selectors_2.next(); !selectors_2_1.done; selectors_2_1 = selectors_2.next()) {
                ...
                var data = styles[selector];
                defs[i++] =
                    "".concat(spaces).concat(selector, " {\n").concat(this.getStyleDefString(data, spaces), "\n").concat(spaces, "}");
            }
        }
    ...
    StyleJsonSheet.prototype.getStyleDefString = function (styles, spaces) {
        var e_4, _a, _b;
            ...
            for (var properties_1 = __values(properties), properties_1_1 = properties_1.next(); !properties_1_1.done; properties_1_1 = properties_1.next()) {
                ...
                values[i++] =
                    styles[property] instanceof Object
                        ? spaces +
                            this.getStyleRules((_b = {},
                                _b[property] = styles[property],
                                _b), spaces + '  ').join('\n' + spaces)
