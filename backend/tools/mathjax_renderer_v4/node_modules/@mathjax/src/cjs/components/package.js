...
var Package = (function () {
    ...
    Package.loadPromise = function (name) {
        var config = (loader_js_1.CONFIG[name] || {});
        var promise = config.extraLoads
            ? loader_js_1.Loader.load.apply(loader_js_1.Loader, __spreadArray([], __read(config.extraLoads), false)) : Promise.resolve();
        var checkReady = config.checkReady || (function () { return Promise.resolve(); });
        return promise.then(function () { return checkReady(); });
    };
    ...
    Package.prototype.makeDependencies = function () {
        ...
        var name = this.name;
        var dependencies = [];
        if (Object.hasOwn(loader_js_1.CONFIG.dependencies, name)) {
        ...
        try {
            ...
            if (result instanceof Promise) {
                result
                    ...
                    .then(function () { return _this.checkLoad(); })
                    .catch(function (err) {
    ...
    Package.prototype.loadScript = function (url) {
        var _this = this;
        var script = context_js_1.context.document.createElement('script');
        script.src = url;
        ...
        context_js_1.context.document.head.appendChild(script);
    };
    ...
    Package.prototype.checkLoad = function () {
        ...
        Package.loadPromise(this.name)
            .then(function () { return _this.loaded(); })
