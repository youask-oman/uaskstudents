...
function configAutoload(config, jax) {
    ...
    var macros = parser.handlers.get(HandlerTypes_js_1.HandlerType.MACRO);
    var environments = parser.handlers.get(HandlerTypes_js_1.HandlerType.ENVIRONMENT);
            ...
            try {
                for (var macs_1 = (e_4 = void 0, __values(macs)), macs_1_1 = macs_1.next(); !macs_1_1.done; macs_1_1 = macs_1.next()) {
                    ...
                    if (!macros.lookup(name_1) || name_1 === 'color') {
                        AutoloadMacros.add(name_1, new Token_js_1.Macro(name_1, Autoload, [extension, true]));
                    }
                }
            }
            ...
            try {
                for (var envs_2 = (e_5 = void 0, __values(envs)), envs_2_1 = envs_2.next(); !envs_2_1.done; envs_2_1 = envs_2.next()) {
                    ...
                    if (!environments.lookup(name_2)) {
                        AutoloadEnvironments.add(name_2, new Token_js_1.Macro(name_2, Autoload, [extension, false]));
                    }
                }
            }
...
var AutoloadMacros = new TokenMap_js_1.CommandMap('autoload-macros', {});
var AutoloadEnvironments = new TokenMap_js_1.CommandMap('autoload-environments', {});
exports.AutoloadConfiguration = Configuration_js_1.Configuration.create('autoload', (_a = {},
    _a[HandlerTypes_js_1.ConfigurationType.HANDLER] = (_b = {},
        _b[HandlerTypes_js_1.HandlerType.MACRO] = ['autoload-macros'],
        _b[HandlerTypes_js_1.HandlerType.ENVIRONMENT] = ['autoload-environments'],
        _b),
    ...
    _a[HandlerTypes_js_1.ConfigurationType.CONFIG] = configAutoload,
    _a[HandlerTypes_js_1.ConfigurationType.INIT] = initAutoload,
