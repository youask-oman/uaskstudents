...
var BaseItem = (function (_super) {
    ...
    BaseItem.prototype.addLatexItem = function (node, prefix) {
        if (prefix === void 0) { prefix = ''; }
        var str = this.startStr.slice(this.startI, this.stopI);
        if (str) {
            var tex = prefix ? prefix + str : str;
            node.attributes.set(TexConstants_js_1.TexConstant.Attr.LATEXITEM, tex);
            if (tex !== '}') {
                node.attributes.set(TexConstants_js_1.TexConstant.Attr.LATEX, tex);
            }
        }
    };
