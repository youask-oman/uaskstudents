...
var ParseOptions = (function () {
    ...
    ParseOptions.getVariant = new Map([
        [
            'TeX',
            function (c, b) {
                return b ? (c.match(/^[\u0391-\u03A9\u03F4]/) ? MATHVARIANT.NORMAL : '') : '';
            },
        ],
        ['ISO', function (_c) { return MATHVARIANT.ITALIC; }],
        [
            'French',
            function (c) {
                return c.normalize('NFD').match(/^[a-z]/)
                    ? MATHVARIANT.ITALIC
                    : MATHVARIANT.NORMAL;
            },
        ],
        ['upright', function (_c) { return MATHVARIANT.NORMAL; }],
    ]);
    return ParseOptions;
}());
