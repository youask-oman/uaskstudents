...
var FindAsciiMath = (function (_super) {
    ...
    FindAsciiMath.prototype.getPatterns = function () {
        ...
        var starts = [];
        this.end = {};
        options['delimiters'].forEach(function (delims) {
    ...
    FindAsciiMath.prototype.findEnd = function (text, n, start, end) {
        ...
        return !match
            ? null
            : (0, MathItem_js_1.protoItem)(start[0], match.index < i ? '' : text.substring(i, match.index), match[0], n, start.index, match.index + match[0].length, display);
    };
