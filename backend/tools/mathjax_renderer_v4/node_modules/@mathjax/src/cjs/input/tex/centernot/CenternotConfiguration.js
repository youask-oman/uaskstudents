...
exports.CenternotConfiguration = void 0;
...
new TokenMap_js_1.CommandMap('centernot', {
    centerOver: CenterOver,
    centernot: [BaseMethods_js_1.default.Macro, '\\centerOver{#1}{{\u29F8}}', 1],
});
...
exports.CenternotConfiguration = Configuration_js_1.Configuration.create('centernot', (_a = {},
    _a[HandlerTypes_js_1.ConfigurationType.HANDLER] = { macro: ['centernot'] },
    _a[HandlerTypes_js_1.ConfigurationType.POSTPROCESSORS] = [filterCenterOver],
    _a));
