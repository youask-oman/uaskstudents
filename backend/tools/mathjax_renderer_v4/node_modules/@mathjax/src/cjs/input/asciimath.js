...
var legacy_js_1 = require("./asciimath/legacy.js");
...
var AsciiMath = (function (_super) {
    ...
    function AsciiMath(options) {
        ...
        _this.findAsciiMath =
            _this.options['FindAsciiMath'] || new FindAsciiMath_js_1.FindAsciiMath(find);
        return _this;
    }
    AsciiMath.prototype.compile = function (math, _document) {
        return legacy_js_1.LegacyAsciiMath.Compile(math.math, math.display);
    };
