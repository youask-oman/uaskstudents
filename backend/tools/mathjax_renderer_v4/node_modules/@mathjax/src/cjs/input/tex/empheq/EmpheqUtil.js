...
exports.EmpheqUtil = {
    splitOptions: function (text, allowed) {
        ...
        return ParseUtil_js_1.ParseUtil.keyvalOptions(text, allowed, true);
    },
    ...
    topRowTable: function (original, parser) {
        var table = ParseUtil_js_1.ParseUtil.copyNode(original, parser);
    ...
    rowspanCell: function (mtd, tex, table, parser, env) {
        mtd.appendChild(parser.create('node', 'mpadded', [
            this.cellBlock(tex, ParseUtil_js_1.ParseUtil.copyNode(table, parser), parser, env),
    ...
    right: function (table, original, right, parser, env) {
        ...
        var m = exports.EmpheqUtil.columnCount(table) + (row.isKind('mlabeledtr') ? 1 : 0);
