...
var Configuration = (function () {
    function Configuration(name, handler, fallback, items, tags, options, nodes, preprocessors, postprocessors, initMethod, configMethod, priority, parser) {
        ...
        this.parser = parser;
        this.handler = Object.assign((_a = {},
            _a[HandlerTypes_js_1.HandlerType.CHARACTER] = [],
            _a[HandlerTypes_js_1.HandlerType.DELIMITER] = [],
            _a[HandlerTypes_js_1.HandlerType.MACRO] = [],
            _a[HandlerTypes_js_1.HandlerType.ENVIRONMENT] = [],
            _a), handler);
    }
    ...
    Configuration._create = function (name, config) {
        ...
        var priority = (_a = config.priority) !== null && _a !== void 0 ? _a : PrioritizedList_js_1.PrioritizedList.DEFAULTPRIORITY;
        ...
        return new Configuration(name, config[HandlerTypes_js_1.ConfigurationType.HANDLER] || {}, config[HandlerTypes_js_1.ConfigurationType.FALLBACK] || {}, config[HandlerTypes_js_1.ConfigurationType.ITEMS] || {}, config[HandlerTypes_js_1.ConfigurationType.TAGS] || {}, config[HandlerTypes_js_1.ConfigurationType.OPTIONS] || {}, config[HandlerTypes_js_1.ConfigurationType.NODES] || {}, preprocessors, postprocessors, init, conf, priority, parser);
    };
    Configuration.create = function (name, config) {
        if (config === void 0) { config = {}; }
        var configuration = Configuration._create(name, config);
        exports.ConfigurationHandler.set(name, configuration);
...
var ParserConfiguration = (function () {
    ...
    ParserConfiguration.prototype.warn = function (message) {
