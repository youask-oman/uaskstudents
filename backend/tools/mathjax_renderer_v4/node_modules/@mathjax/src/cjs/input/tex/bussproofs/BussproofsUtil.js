...
var addSpace = function (config, inf, space, right) {
    ...
    if (NodeUtil_js_1.default.isType(mspace, 'mspace')) {
        NodeUtil_js_1.default.setAttribute(mspace, 'width', UnitUtil_js_1.UnitUtil.em(UnitUtil_js_1.UnitUtil.dimen2em(NodeUtil_js_1.default.getAttribute(mspace, 'width')) +
            space));
        return;
    }
    mspace = config.nodeFactory.create('node', 'mspace', [], {
        width: UnitUtil_js_1.UnitUtil.em(space),
    });
    if (right) {
