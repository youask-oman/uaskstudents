                ...
                if (a || b) {
                    ...
                    if (a) {
                        NodeUtil_js_1.default.appendChildren(mml, [
                            new TexParser_js_1.default('\\scriptstyle\\raise.125em{\\vcenter{\\llap{' + a + '}}}', parser.stack.env, parser.configuration).mml(),
                        ]);
                    }
                    ...
                    if (b) {
                        NodeUtil_js_1.default.appendChildren(mml, [
                            new TexParser_js_1.default('\\scriptstyle\\raise.125em{\\vcenter{\\rlap{' + b + '}}}', parser.stack.env, parser.configuration).mml(),
                        ]);
                    }
                }
            }
