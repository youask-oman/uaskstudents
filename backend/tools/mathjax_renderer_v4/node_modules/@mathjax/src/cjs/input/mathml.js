...
var MathML = (function (_super) {
    ...
    function MathML(options) {
        ...
        _this.mathml =
            _this.options.MathMLCompile || new MathMLCompile_js_1.MathMLCompile(compile);
        _this.mmlFilters = new FunctionList_js_1.FunctionList(_this.options.mmlFilters);
        return _this;
    }
    ...
    MathML.prototype.compile = function (math, document) {
        ...
        if (!mml ||
            ...
            if (this.options['parseAs'] === 'html') {
                mathml = "<html><head></head><body>".concat(mathml, "</body></html>");
            }
