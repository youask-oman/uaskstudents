...
(0, MathItem_js_1.newState)('STYLES', MathItem_js_1.STATE.INSERTED + 1);
var HTMLDocument = (function (_super) {
    ...
    function HTMLDocument(document, adaptor, options) {
        ...
        _this.domStrings =
            _this.options['DomStrings'] || new HTMLDomStrings_js_1.HTMLDomStrings(dom);
    ...
    HTMLDocument.prototype.findPosition = function (N, index, delim, nodes) {
        ...
        var inc = 1 / (nodes[N].length || 1);
        var i = N;
        try {
            for (var _b = __values(nodes[N]), _c = _b.next(); !_c.done; _c = _b.next()) {
                var _d = __read(_c.value, 2), node = _d[0], n = _d[1];
                if (index <= n && adaptor.kind(node) === '#text') {
                    return { i: i, node: node, n: Math.max(index, 0), delim: delim };
                }
                index -= n;
                i += inc;
            }
    ...
    HTMLDocument.prototype.findMath = function (options) {
        ...
        if (!this.processed.isSet('findMath')) {
            ...
            var containers = this.adaptor.getElements(options.elements, this.document);
            try {
                for (var _b = __values(this.inputJax), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var jax = _c.value;
                    var list = jax.processStrings
    ...
    HTMLDocument.prototype.findMathFromStrings = function (jax, containers) {
        var e_3, _a, e_4, _b;
        var strings = [];
        var nodes = [];
        try {
            for (var containers_1 = __values(containers), containers_1_1 = containers_1.next(); !containers_1_1.done; containers_1_1 = containers_1.next()) {
                ...
                var _c = __read(this.domStrings.find(container), 2), slist = _c[0], nlist = _c[1];
                strings.push.apply(strings, __spreadArray([], __read(slist), false));
                nodes.push.apply(nodes, __spreadArray([], __read(nlist), false));
            }
        }
        ...
        try {
            for (var _d = __values(jax.findMath(strings)), _e = _d.next(); !_e.done; _e = _d.next()) {
                var math = _e.value;
    ...
    HTMLDocument.prototype.findMathFromDOM = function (jax, containers) {
        var e_5, _a, e_6, _b, _c;
        var items = [];
        try {
            for (var containers_2 = __values(containers), containers_2_1 = containers_2.next(); !containers_2_1.done; containers_2_1 = containers_2.next()) {
                ...
                try {
                    for (var _d = (e_6 = void 0, __values(jax.findMath(container))), _e = _d.next(); !_e.done; _e = _d.next()) {
                        var math = _e.value;
        ...
        return new ((_c = this.options.MathList).bind.apply(_c, __spreadArray([void 0], __read(items), false)))();
    };
    ...
    HTMLDocument.prototype.addPageElements = function () {
        var adaptor = this.adaptor;
        var body = adaptor.body(this.document);
        var node = this.documentPageElements();
        if (node) {
            var child = adaptor.firstChild(body);
            if (child) {
    ...
    HTMLDocument.OPTIONS = __assign(__assign({}, MathDocument_js_1.AbstractMathDocument.OPTIONS), { renderActions: (0, Options_js_1.expandable)(__assign(__assign({}, MathDocument_js_1.AbstractMathDocument.OPTIONS.renderActions), { styles: [MathItem_js_1.STATE.STYLES, '', 'updateStyleSheet', false] })), MathList: HTMLMathList_js_1.HTMLMathList, MathItem: HTMLMathItem_js_1.HTMLMathItem, DomStrings: null });
    return HTMLDocument;
}(MathDocument_js_1.AbstractMathDocument));
