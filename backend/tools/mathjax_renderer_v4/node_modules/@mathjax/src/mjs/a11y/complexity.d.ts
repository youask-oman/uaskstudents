...
export declare function ComplexityMathItemMixin<N, T, D, B extends EMItemC<N, T, D>>(BaseMathItem: B, computeComplexity: (math: ComplexityMathItem<N, T, D>) => void): CMItemC<N, T, D> & B;
