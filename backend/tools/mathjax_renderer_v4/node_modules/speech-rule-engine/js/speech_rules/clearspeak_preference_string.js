import { DynamicCstr, DynamicProperties } from '../rule_engine/dynamic_cstr.js';
...
const AUTO = 'Auto';
export function fromPreference(pref) {
...
export function toPreference(pref) {
...
export function findPreference(prefs, kind) {
    if (prefs === 'default') {
        return AUTO;
    }
...
export function addPreference(prefs, kind, value) {
    if (prefs === 'default') {
        return kind + '_' + value;
    }
    const parsed = fromPreference(prefs);
