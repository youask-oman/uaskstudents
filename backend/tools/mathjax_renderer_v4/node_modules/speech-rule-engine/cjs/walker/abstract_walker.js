...
class AbstractWalker {
    ...
    update(options) {
        (0, engine_setup_js_1.setupEngine)(options).then(() => SpeechGeneratorFactory.generator('Tree').getSpeech(this.node, this.getXml()));
    }
    nextRules() {
...
//# sourceMappingURL=abstract_walker.js.map