...
function numberToWords(num) {
    ...
    if (exports.NUMBERS.special['tens-' + engine_js_1.Engine.getInstance().options.subiso]) {
        exports.NUMBERS.tens = exports.NUMBERS.special['tens-' + engine_js_1.Engine.getInstance().options.subiso];
    }
    let pos = 0;
    let str = '';
    while (num > 0) {
...
//# sourceMappingURL=numbers_fr.js.map