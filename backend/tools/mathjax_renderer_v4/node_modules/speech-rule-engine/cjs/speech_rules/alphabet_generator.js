...
const Alphabet = __importStar(require("./alphabet.js"));
const engine_js_1 = require("../common/engine.js");
const L10n = __importStar(require("../l10n/l10n.js"));
...
function generate(locale) {
    const oldLocale = engine_js_1.Engine.getInstance().options.locale;
    ...
    engine_js_1.Engine.getInstance().options.locale = oldLocale;
    L10n.setLocale();
}
...
//# sourceMappingURL=alphabet_generator.js.map