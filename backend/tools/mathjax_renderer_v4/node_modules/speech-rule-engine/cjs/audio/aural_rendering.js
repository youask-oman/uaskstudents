...
function setSeparator(sep) {
    const renderer = renderers.get(engine_js_1.Engine.getInstance().options.markup);
    if (renderer) {
...
function isXml() {
    return (renderers.get(engine_js_1.Engine.getInstance().options.markup) instanceof xml_renderer_js_1.XmlRenderer);
}
//# sourceMappingURL=aural_rendering.js.map